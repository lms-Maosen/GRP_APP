...
class _HomeTabState extends State<HomeTab> {
  ...
  Widget _buildDisconnectedState() {
    ...
    if (_devices.isNotEmpty) {
      return _buildDeviceListState(myFitnessPodDevices, otherDevices);
    } else {
  ...
  Widget _buildDeviceListState(List<BluetoothDevice> myFitnessPodDevices, List<BluetoothDevice> otherDevices) {
    return Column(
      children: [
        Align(
          ...
          child: Column(
            children: [
              ...
              if (otherDevices.isNotEmpty)
                _buildOtherDevicesSection(otherDevices),
  ...
  Widget _buildOtherDevicesSection(List<BluetoothDevice> otherDevices) {
    return Card(
      margin: const EdgeInsets.all(16.0),
      child: ExpansionTile(
        // 只保留左边的箭头，移除右边的箭头
